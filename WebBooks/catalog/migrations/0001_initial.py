    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Введите имя автора', max_length=100, verbose_name='Имя автора')),
                ('last_name', models.CharField(help_text='Введиите фамилию автра', max_length=100, verbose_name='Фамилия автора')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(help_text='Введите описание книги', max_length=1000, verbose_name='Аннотация книги')),
                ('isbn', models.CharField(help_text='Должно содержать 13 символов', max_length=13, verbose_name='ISBN книги')),
                ('autor', models.ForeignKey(help_text='Выберете автора книги', null=True, on_delete=django.db.models.deletion.CASCADE, to='catalog.autor', verbose_name='Автор книги')),
